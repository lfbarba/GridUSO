...
\MM{This is not a partial order: it is not transitive. You'll want to decide
    whether you want the transitive closure or not, and stick to one
    definition.}
...
\MM{Shouldn't all this be moved to section \ref{section:the_sink_finding_algorithm}?}
...
\begin{proof}
    Follows from corollary \ref{cor:num-USO-mn} and Stirling's formula.
\end{proof}
