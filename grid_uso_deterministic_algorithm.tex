...
Since this set system has unbounded VC-dimension for general Gird USOs as shown in Figure~\ref{}, these deterministic algorithms are less efficient that exploring the entire grid exhaustively. 
