...
\begin{corollary}
\label{cor:the_sink_of_the_sink_of_the_induced_orientation_is_the_global_sink}
Let $G = K_X \times K_Y$ be a grid unique sink orientation,
and let $A$ and $B$ be partitions of $X$ and $Y$, respectively.
