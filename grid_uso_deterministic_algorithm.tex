...
\newcommand{\JN}[1]{\marginpar{\parbox{3.7cm}{{\small {\bf JN:} #1}}}} %Jerri
\newcommand{\LB}[1]{\marginpar{\parbox{3.7cm}{{\small {\bf LB:} #1}}}} %Luis
\newcommand{\MM}[1]{\marginpar{\parbox{3.7cm}{{\small {\bf MM:} #1}}}} %Malte
\newcommand{\AT}[1]{\marginpar{\parbox{3.7cm}{{\small {\bf AT:} #1}}}} %Antonis
\newcommand{\BG}[1]{\marginpar{\parbox{3.7cm}{{\small {\bf BG:} #1}}}} %Bernd
%\newcommand{\JN}[1]{}
...
Using the above construction, there are randomized algorithms for LP-type problems that imply expected $O(m+n)$ edge queries for grid USOs~\cite{MatousekSW96}. 
While there exist deterministic algorithms with matching performance \cite{chan16,ChazelleM96}, they make an extra assumption  
(see Computational assumption 2 in \cite{ChazelleM96}). 
Namely, they require that a set system has constant VC-dimension which does not hold for the LP-type problem described above 
(refer to~\cite{matouvsek2002lectures} for further information on VC-dimension). \AT{Here we refer to the construction which will be in the appendix.}
