...
The idea of our algorithm is the following: Using Lemma~\ref{corollary: n/4 indegree}, we find a vertex with ``large'' \indegree, then we apply repeatedly and algorithm that finds new vertices with ``larger'' \indegree until finding one with \indegree either $[$
