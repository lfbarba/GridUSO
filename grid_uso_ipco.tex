...
So far in the previous sections we have mainly discussed the vertex oracle model.
Recall that in the \emph{edge oracle model} considered here, the algorithm accesses the
