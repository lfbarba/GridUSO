...
We denote by \emph{\sinkmn} the \sink problem where the input is an $(m,n)$-grid. \AT{The input is not a grid, is it?}
...
%The computational model here is to perform queries  entries of the matrix who, in turn, reveal their values.
...
%which at every query reveals an entry of the matrix.
