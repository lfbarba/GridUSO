...
\title{Deterministic Algorithms for Unique Sink Orientations of the Grid}
...
\vspace{-0.1in}
\section{Conclusions}
In this paper, we have discusses the existence of efficient deterministic algorithms to find the sink of a $(m,n)$-grid. In the vertex query model 
