...
\caption{An illustration for Lemma~\ref{lem:seed_lemma_for_square_matrices}. The three black circles on the diagonal form $V'$. The dashed edges denote that there is a path from each vertex in $V'$ to $v$. On the right hand side the vertices belonging to $W$ are marked with a square. }
\label{fig:seedlem1}
\end{figure}
