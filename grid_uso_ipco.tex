...
For our algorithms to work it is important that the orientation is acyclic. \citet{grid08} have shown that grid USOs are acyclic. Furthermore, to check whether a grid orientation is a USO it is enough to check that the orientation is acycli and that every $(2,2)$-subgrid is a USO.
